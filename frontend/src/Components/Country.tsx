...
interface CountrySelectorProps {
  onCountrySelect: (selectedCountry: CountryOption) => void;
}
...
const CountrySelector: React.FC<CountrySelectorProps> = ({ onCountrySelect }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const mobileCode = selectedOption.getAttribute('data-mobileCode') || '';
    const countryName = selectedOption.text;

    setSelectedCountry({ value: countryCode, label: countryName, mobileCode });
    onCountrySelect({ value: countryCode, label: countryName, mobileCode });
  };
